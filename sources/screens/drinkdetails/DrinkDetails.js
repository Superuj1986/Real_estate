    ...
    return(
        <ScrollView style={{ backgroundColor:"#fff", flex: 1}}>
            <View style={{ position: "relative"}}>
                ...
                >
                    <Ionicons name="chevron-back-outline" size={30} color="white"></Ionicons>
                </TouchableOpacity>
            </View>
            <View style={{paddingHorizontal:12, marginTop: 12}}>
                ...
                <View style={{ flexDirection: "row", marginTop: 20}}>
                    ...
                    <View>
                        ...
                        <View style={{ backgroundColor: "#f4f4f4", borderRadius: 100, paddingHorizontal:8}}>
                            <Picker
                                style={{ width: 140, height: 40}}
                                selectedValue={ice}
                ...
                <View style={{ flexDirection: "row", marginTop: 20}}>
                    <View>
                        ...
                        >
                            ...
                            >
                                <Ionicons name="remove" size={24} color="#2FDBBC"></Ionicons>
                            </TouchableOpacity>
                            <TouchableOpacity
                                onPress={() => {
                                    setAmount((val) => val + 1);
